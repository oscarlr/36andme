...
$mutation_database = parse_database("mutations_to_look_for.txt");
$mutation_database_vcf_format = parse_database_vcf_format("mutations_to_look_for.txt");
...
echo "<br>";
echo "<b>#####################</b><br>";
echo "---- <b>Found disease alleles</b><br>";
echo "<br>";
...
echo "<br>";
echo "----- <b>Done looking for disease alleles</b><br>";
echo "<b>#####################</b><br>";
echo "<br>";
