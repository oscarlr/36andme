...
$mutation_database = parse_database("alleles_to_look_for.txt");
$mutation_database_vcf_format = parse_database_vcf_format("alleles_to_look_for.txt");
...
echo "<br>";
echo "----- <b>Done looking for alleles</b><br>";
echo "<b>#####################</b><br>";
echo "<br>";
